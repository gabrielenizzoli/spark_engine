...
public class WriterFormatter {
    ...
    public static Trigger getStreamTrigger(dataengine.pipeline.model.sink.impl.Trigger trigger) throws DatasetConsumerException {
        if (trigger == null)
            return null;
        if (trigger instanceof dataengine.pipeline.model.sink.impl.Trigger.TriggerContinuousMs)
            return Trigger.Continuous(((dataengine.pipeline.model.sink.impl.Trigger.TriggerContinuousMs) trigger).getMilliseconds());
        if (trigger instanceof dataengine.pipeline.model.sink.impl.Trigger.TriggerIntervalMs)
            return Trigger.ProcessingTime(((dataengine.pipeline.model.sink.impl.Trigger.TriggerIntervalMs) trigger).getMilliseconds());
        if (trigger instanceof dataengine.pipeline.model.sink.impl.Trigger.TriggerOnce)
            return Trigger.Once();
