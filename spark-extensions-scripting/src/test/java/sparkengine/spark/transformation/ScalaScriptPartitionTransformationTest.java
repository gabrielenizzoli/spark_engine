...
class ScalaScriptPartitionTransformationTest extends SparkSessionManager {
    ...
    void testTransformation() {
        ...
        params.setCode("(i:Iterator[String]) => { ctx.acc(\"hi\"); i.map(_.length()) }");

        var tx = new ScalaScriptPartitionTransformation<String, Integer>();
