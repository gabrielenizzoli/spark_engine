...
public class ScalaUdfCompiler {
    ...
    public static UdfDefinition compile(String name, String code) throws UdfCompilationException {
        try {
            ...
            var sparkUdf = (SparkUserDefinedFunction)ScriptEngine.evaluate(udfCode, true, Option.apply(UdfContext.EMPTY_UDF_CONTEXT), Option.apply(UdfContext.class.getName()));
