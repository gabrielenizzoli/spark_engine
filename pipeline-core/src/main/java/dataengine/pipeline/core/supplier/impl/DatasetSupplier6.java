...
import dataengine.spark.transformation.DataTransformation6;
...
/**
 * DatasetSupplier that stores information needed to perform a custom-defined operation on 6 input DatasetSuppliers
 *
...
@Value
@Builder
public class DatasetSupplier6<S1, S2, S3, S4, S5, S6, D> implements DatasetSupplier<D> {
    ...
    @Nonnull
    DataTransformation6<S1, S2, S3, S4, S5, S6, D> transformation;
