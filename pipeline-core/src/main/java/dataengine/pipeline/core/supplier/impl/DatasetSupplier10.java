...
/**
 * DatasetSupplier that stores information needed to perform a custom-defined operation on 10 input DatasetSuppliers
 *
...
@Value
@Builder
public class DatasetSupplier10<S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, D> implements DatasetSupplier<D> {
    ...
    @Nonnull
    DatasetSupplier<S10> parentDatasetSupplier10;
    @Nonnull
