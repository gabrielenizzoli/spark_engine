 ...
 */
public interface DataTransformation5<S1, S2, S3, S4, S5, D> {
     ...
     */
    default <D2> DataTransformation5<S1, S2, S3, S4, S5, D2> andThen(DataTransformation<D, D2> tx) {
     ...
     */
    default <D2> DataTransformation5<S1, S2, S3, S4, S5, D2> andThenEncode(Encoder<D2> encoder) {
