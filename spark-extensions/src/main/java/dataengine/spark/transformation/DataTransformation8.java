 ...
 */
public interface DataTransformation8<S1, S2, S3, S4, S5, S6, S7, S8, D> {
     ...
     */
    default <D2> DataTransformation8<S1, S2, S3, S4, S5, S6, S7, S8, D2> andThen(DataTransformation<D, D2> tx) {
     ...
     */
    default <D2> DataTransformation8<S1, S2, S3, S4, S5, S6, S7, S8, D2> andThenEncode(Encoder<D2> encoder) {
