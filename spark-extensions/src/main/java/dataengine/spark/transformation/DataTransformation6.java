 ...
 */
public interface DataTransformation6<S1, S2, S3, S4, S5, S6, D> {
     ...
     */
    default <D2> DataTransformation6<S1, S2, S3, S4, S5, S6, D2> andThen(DataTransformation<D, D2> tx) {
     ...
     */
    default <D2> DataTransformation6<S1, S2, S3, S4, S5, S6, D2> andThenEncode(Encoder<D2> encoder) {
