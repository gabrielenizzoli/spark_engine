...
import dataengine.pipeline.model.pipeline.collection.Pipelines;
...
class PipelinesTest {
    ...
    public void testSampleSerialization() throws IOException {
        ...
        Assertions.assertNotNull(pipelines.getSteps());
        Assertions.assertTrue(pipelines.getSteps().size() > 0);
